...
Route::get('/questions/{question_id}/answer/{answer_id}/likeAns', 'AnswerController@likeAns')->name('answers.likeAns');
Route::get('/questions/{question_id}/answer/{answer_id}/unlikeAns', 'AnswerController@unlikeAns')->name('answers.unlikeAns');
Route::resources([
